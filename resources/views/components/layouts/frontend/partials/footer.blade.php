<div class="bg-white border-t border-gray-200 dark:bg-boxdark-2 dark:border-gray-700">
  <div class="container px-6 mx-auto">
    <div class="grid grid-cols-1 gap-6 py-10 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
        ...
        <div>
            <p class="font-semibold text-gray-800 dark:text-white">Kategori Berita</p>
            <div class="flex gap-10">
                @isset($categoriesFooter[0])
                    <ul class="flex flex-col items-start mt-5 space-y-2">
    ...
    <div class="flex flex-col lg:flex-row gap-4 items-center justify-between py-10">
        ...
        <div class="flex -mx-2">
            ...
            <a href="#" target="_blank" class="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400" aria-label="Github">
                <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
