<x-layouts.frontend.main title="Kontak">
   <section class="container pt-8 lg:pt-15 relative flex flex-col-reverse px-6 mx-auto sm:px-12 sm:flex-row">
            ...
            <svg class="w-full md:bottom-0 md:absolute lg:block" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 280.34 335.07">
               <defs>
                  ...
                  <linearGradient id="linear-gradient-3" x1="126.34" y1="149.56" x2="155.41" y2="149.56" gradientUnits="userSpaceOnUse">
                     <stop offset="0" stop-color="#746aa6"/><stop offset="0.31" stop-color="#5d5298"/>
                     <stop offset="0.75" stop-color="#423687"/><stop offset="1" stop-color="#382b81"/>
                  </linearGradient>
                  ...
                  <linearGradient id="linear-gradient-5" x1="86.84" y1="99.43" x2="102.91" y2="103.45" gradientUnits="userSpaceOnUse">
                     <stop offset="0" stop-color="#fff" stop-opacity="0"/><stop offset="1" stop-color="#d1b6cb"/>
                  </linearGradient>
                  ...
                  <linearGradient id="linear-gradient-9" x1="1046.73" y1="383.6" x2="1112" y2="382.91" gradientTransform="matrix(-0.72, -0.23, -0.4, 0.83, 1082.07, 67.22)" gradientUnits="userSpaceOnUse">
                     <stop offset="0" stop-color="#eef2fa"/><stop offset="0.27" stop-color="#e5ecf6"/><stop offset="1" stop-color="#d1ddee"/>
                  </linearGradient>
               ...
               <g style="isolation:isolate">
                  <g id="Capa_1" data-name="Capa 1">
                     ...
                     <polygon points="78.83 91.79 106.12 105.34 95.07 113.79 75.88 96.08 78.83 91.79" style="fill:url(#linear-gradient-11)"/><polygon points="106.12 105.34 115.03 111.93 113.2 100.35 110.3 97.06 106.12 105.34" style="fill:url(#linear-gradient-12)"/>
      ...
      <div class="relative z-10 flex flex-col items-start mt-8 mb-16 lg:mb-10 lg:ml-auto sm:w-5/12 md:w-6/12 md:py-5 lg:w-4/12 sm:items-end sm:text-right sm:mt-0 lg:pt-20 sm:mb-0">
         <div class="bg-white dark:bg-gray-700 shadow-2xl rounded-xl w-full p-6">
            ...
            <form action="{{route('contact.store')}}" method="POST">
               ...
               <div class="mb-6 flex flex-col gap-1 justify-start items-start">
                  <x-frontend.textarea value="{{old('pesan')}}" type="text" name="pesan" placeholder="Masukan pesan">
                     <x-slot:icon>
               ...
               <div>
                  <button
                     type="submit"
                     class="w-full p-3 text-white transition border rounded-2xl bg-primary border-primary hover:bg-opacity-90"
                     >
                     Kirim Pesan
                  </button>
               </div>
            </form>
            <p class="text-sm text-center text-gray-400 dark:text-gray-100 pt-4 font-semibold">
               <span>Powered by <a href="https://Web3Forms.com" class="text-gray-600 dark:text-gray-300" target="_blank" rel="noopener noreferrer">Web3Forms</a></span>
            </p>
            <div>
               <span class="absolute -right-6 top-13 -z-1">
                  <x-icons.blirik color="#DC3545"/>
               </span>
               <span class="absolute -left-6 bottom-54 -z-1">
                  <x-icons.blirik color="#DC3545"/>
               </span>
            </div>
         </div>
      ...
      {{-- skyline --}}
      <svg class="absolute bottom-0 left-0 w-full" id="Capa_1" data-name="Capa 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 497.5 141.26">
         <title>skyline</title>
         ...
         <rect x="304.77" y="105.65" width="18.73" height="43.12" style="fill:#d5daee"/><path d="M314.26,80.81V30.35h-4V28h-.9v-.37H309v-.66h-.67v-5h-.43l-.23-4.37h-.19l-.24,4.37h-.43v5h-.67v.66h-.37V28h-.9v2.4h-11.1l-6.4,7.79V80.81Zm-6.79-54.08h-.2V22.25h.2Zm.41,0h-.21V22.25h.21Z" style="fill:#d0d4ea"/>
