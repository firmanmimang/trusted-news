  ...
  <div class="overflow-x-auto sm:rounded-lg mt-5">
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
      ...
      <tbody>
        @forelse ($news as $item)
          <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            <td scope="row" class="text-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
              ...
              <form action="{{route('cms.news.in-house.delete', $item)}}" method="post" class="text-center w-full flex items-center justify-center">
                @csrf
                @method('DELETE')
        ...
        @empty
          <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            <td scope="row" colspan="4" class="text-center font-semibold p-3">No Data</td>
          </tr>
        @endforelse
      </tbody>
    </table>
