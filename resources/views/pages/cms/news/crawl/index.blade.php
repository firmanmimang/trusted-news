<x-layouts.cms.main title="News Crawl Management">
  <x-cms.title title="News Crawl Management" subtitle="News Crawl on {{env('APP_NAME')}}"/>
    
  <div class="flex items-stretch justify-between mt-8">
    <form action="{{route('cms.news.crawl.index')}}" method="GET" class="relative">
      @if (request('size'))
  ...
  <div class="mt-5 overflow-x-auto sm:rounded-lg">
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
      ...
      <tbody>
          ...
          <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            <td scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
              <div class="pl-3">
                ...
                <div class="font-normal text-gray-500">author : {{$item->author_crawl}}</div>
            ...
            <td scope="row" class="px-6 py-4 font-medium text-center text-gray-900 whitespace-nowrap dark:text-white">
              <a href="{{route('cms.news.crawl.edit', $item)}}" class="block font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
              <form action="{{route('cms.news.crawl.delete', $item)}}" method="post" class="flex items-center justify-center w-full text-center">
                @csrf
                @method('DELETE')
        ...
        @empty
          <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            <td scope="row" colspan="5" class="p-3 font-semibold text-center">No Data</td>
          </tr>
        @endforelse
      </tbody>
    </table>
